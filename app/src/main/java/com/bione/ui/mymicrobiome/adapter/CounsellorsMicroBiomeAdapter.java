...
public class CounsellorsMicroBiomeAdapter extends RecyclerView.Adapter<CounsellorsMicroBiomeAdapter.MyViewHolder> {

    private ArrayList<CounsellorsData> counsellorsData;
    private int checkedPosition = -1;
    private final CategorySelect2.OnItemClickListener listener;

    public CounsellorsMicroBiomeAdapter(final ArrayList<CounsellorsData> counsellorsData, final CategorySelect2.OnItemClickListener listener) {

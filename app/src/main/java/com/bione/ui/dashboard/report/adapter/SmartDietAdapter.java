...
public class SmartDietAdapter extends RecyclerView.Adapter<SmartDietAdapter.SelectViewHolder> {

    private List<FoodRecommendation> foodRecommendationList;

    // Constructor
    public SmartDietAdapter(ArrayList<FoodRecommendation> foodRecommendationList) {
    ...
    public void setArrayList(ArrayList<FoodRecommendation> foodList) {
        foodRecommendationList.clear();
        foodRecommendationList.addAll(foodList);

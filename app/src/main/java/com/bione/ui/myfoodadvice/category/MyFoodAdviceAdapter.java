...
import com.bione.ui.myfoodadvice.subcategory.SubFoodAdviceActivity;

import java.util.List;

public class MyFoodAdviceAdapter extends RecyclerView.Adapter<MyFoodAdviceAdapter.MyViewHolder> {

    private Context mContext;
    private List<CommonListData> reportType;

    public MyFoodAdviceAdapter(final Context context) {
        this.mContext = context;
    }

    public MyFoodAdviceAdapter(final Context context, final List<CommonListData> reportType) {
        this.mContext = context;
...
//        holder.ivLeft.setImageResource(reportType.get(position).getDrawable());
        ...
        holder.llMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, SubFoodAdviceActivity.class);
